...
const Sidebar = () => {
    ...
    // Destructure the state and actions from the match store
    const { getMyMatches, matches, isLoadingMyMatches, error } = useMatchStore();
                ...
                <div className='flex flex-col h-full'>
                    ...
                    <div className='flex-grow overflow-y-auto p-4 z-10 relative'>
                        {isLoadingMyMatches ? (
                            ...
                            <div className='text-red-500 text-center'>Error fetching matches.</div>
                        ) : matches.length === 0 ? (
                            <NoMatchesFound />
                        ) : (
                            matches.map((match) => (
